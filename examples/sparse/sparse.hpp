...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in './examples/sparse/sparse.stan', line 30, column 2 to column 29)",
                                                      " (in './examples/sparse/sparse.stan', line 32, column 2 to column 18)",
                                                      " (in './examples/sparse/sparse.stan', line 33, column 2 to column 41)",
                                                      ...
                                                      " (in './examples/sparse/sparse.stan', line 15, column 2 to column 28)",
                                                      " (in './examples/sparse/sparse.stan', line 17, column 2 to column 17)",
...
class sparse_model : public model_base_crtp<sparse_model> {
 ...
 public:
  ...
  sparse_model(stan::io::var_context& context__,
    ...
    try {
        ...
        for (size_t sym1__ = 1; sym1__ <= stan::math::size(nz_rows); ++sym1__) {
          ...
          assign(x,
            cons_list(index_uni(nz_cols[(sym1__ - 1)]),
              cons_list(index_uni(nz_rows[(sym1__ - 1)]), nil_index_list())),
      ...
      data_cool = rvalue(xx,
                    cons_list(index_uni(1),
                      cons_list(index_uni(1), nil_index_list())), "xx");
      current_statement__ = 15;
      assign(xx,
        cons_list(index_uni(1), cons_list(index_uni(1), nil_index_list())),
        5.0, "assigning variable xx");
      ...
      assign(xx,
        ...
        rvalue(x,
          cons_list(index_min_max(1, 10),
            cons_list(index_min_max(1, 10), nil_index_list())), "x"),
        "assigning variable xx");
...
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      for (size_t sym1__ = 1; sym1__ <= N; ++sym1__) {
        ...
        for (size_t sym2__ = 1; sym2__ <= M; ++sym2__) {
          ...
          assign(ZZ,
            cons_list(index_uni(sym1__),
              cons_list(index_uni(sym2__), nil_index_list())),
            std::numeric_limits<double>::quiet_NaN(), "assigning variable ZZ");
        }}
      current_statement__ = 2;
      ...
      current_statement__ = 3;
      param_cool = rvalue(ZZ,
                     cons_list(index_uni(1),
                       cons_list(index_uni(1), nil_index_list())), "ZZ");
      current_statement__ = 4;
      assign(ZZ,
        cons_list(index_uni(1), cons_list(index_uni(1), nil_index_list())),
        10.0, "assigning variable ZZ");
      ...
      assign(ZZ,
        ...
        multiply(
          rvalue(VV,
            cons_list(index_min_max(1, 10),
              cons_list(index_min_max(1, 10), nil_index_list())), "VV"),
          10.0), "assigning variable ZZ");
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
...
(void) function__;  // suppress unused var warning
      ...
      for (size_t sym1__ = 1; sym1__ <= N; ++sym1__) {
        for (size_t sym2__ = 1; sym2__ <= M; ++sym2__) {
          vars__.push_back(
            rvalue(ZZ,
              cons_list(index_uni(sym2__),
                cons_list(index_uni(sym1__), nil_index_list())), "ZZ"));}}
            ...
            for (size_t sym3__ = 1; sym3__ <= nz_cols; ++sym3__) {
              {
                for (size_t sym4__ = 1; sym4__ <= nz_rows; ++sym4__) {
                  {
                    param_names__.push_back(std::string() + "VV" + '.' + std::to_string(sym4__) + '.' + std::to_string(sym3__) + '.' + std::to_string(sym2__) + '.' + std::to_string(sym1__));
                  }}
              }}
          }}
      }}
      ...
      for (size_t sym1__ = 1; sym1__ <= M; ++sym1__) {
        {
          for (size_t sym2__ = 1; sym2__ <= N; ++sym2__) {
            {
              param_names__.push_back(std::string() + "ZZ" + '.' + std::to_string(sym2__) + '.' + std::to_string(sym1__));
            }}
        }}
  ...
  std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"VV\",\"type\":{\"name\":\"sparse_matrix\",\"nonzero rows\":" << nz_rows << ",\"nonzero cols\":" << nz_cols << ",\"rows\":" << N << ",\"cols\":" << M << "},\"block\":\"parameters\"},{\"name\":\"ZZ\",\"type\":{\"name\":\"sparse_matrix\",\"rows\":" << N << ",\"cols\":" << M << "},\"block\":\"transformed_parameters\"},{\"name\":\"param_cool\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"}]";
    return s__.str();
