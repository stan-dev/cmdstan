...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in './examples/sparse/sparse.stan', line 12, column 2 to column 43)",
                                                      " (in './examples/sparse/sparse.stan', line 16, column 2 to column 40)",
...
(void) function__;  // suppress unused var warning
  ...
  std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"VV\",\"type\":{\"name\":\"sparse_matrix\",\"nonzero rows\":" << nz_rows << ",\"nonzero cols\":" << nz_cols << ",\"rows\":" << N << ",\"cols\":" << M << "},\"block\":\"parameters\"},{\"name\":\"ZZ\",\"type\":{\"name\":\"sparse_matrix\",\"rows\":" << N << ",\"cols\":" << M << "},\"block\":\"transformed_parameters\"}]";
    return s__.str();
