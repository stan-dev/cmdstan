...
one_comp_mm_elim_abs(const T0__& t, const std::vector<T1__>& y,
  ...
  try {
    ...
    k_a = rvalue(theta, "theta", index_uni(1));
    local_scalar_t__ K_m;
    K_m = DUMMY_VAR__;
    
    current_statement__ = 34;
    K_m = rvalue(theta, "theta", index_uni(2));
    local_scalar_t__ V_m;
    V_m = DUMMY_VAR__;
    
    current_statement__ = 35;
    V_m = rvalue(theta, "theta", index_uni(3));
    local_scalar_t__ D;
    D = DUMMY_VAR__;
    
    current_statement__ = 36;
    D = rvalue(x_r, "x_r", index_uni(1));
    local_scalar_t__ V;
    V = DUMMY_VAR__;
    
    current_statement__ = 37;
    V = rvalue(x_r, "x_r", index_uni(2));
    ...
    elim = (((V_m / V) * rvalue(y, "y", index_uni(1))) /
             (K_m + rvalue(y, "y", index_uni(1))));
    ...
    assign(dydt, (dose - elim), "assigning variable dydt", index_uni(1));
...
class one_comp_model final : public model_base_crtp<one_comp_model> {
 ...
 public:
  ...
  one_comp_model(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ = "one_comp_model_namespace::one_comp_model";
    ...
    try {
      ...
      current_statement__ = 26;
      C_hat = context__.vals_r("C_hat");
      current_statement__ = 27;
      x_r = std::vector<double>(2, std::numeric_limits<double>::quiet_NaN());
      
      current_statement__ = 27;
      assign(x_r, std::vector<double>{D, V}, "assigning variable x_r");
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "one_comp_model_namespace::log_prob";
    (void) function__;  // suppress unused var warning
    ...
    try {
      ...
      k_a = in__.template read_constrain_lb<local_scalar_t__, jacobian__>(0,
              lp__);
      local_scalar_t__ K_m;
      K_m = DUMMY_VAR__;
      
      current_statement__ = 2;
      K_m = in__.template read_constrain_lb<local_scalar_t__, jacobian__>(0,
              lp__);
      local_scalar_t__ V_m;
      V_m = DUMMY_VAR__;
      
      current_statement__ = 3;
      V_m = in__.template read_constrain_lb<local_scalar_t__, jacobian__>(0,
              lp__);
      ...
      
      {
        ...
        assign(theta, std::vector<local_scalar_t__>{k_a, K_m, V_m},
      ...
      }
      {
        ...
        for (int n = 1; n <= N_t; ++n) {
          ...
          lp_accum__.add(
            lognormal_lpdf<propto__>(rvalue(C_hat, "C_hat", index_uni(n)),
              stan::math::log(rvalue(C, "C", index_uni(n), index_uni(1))),
              sigma));
        }
      }
    } catch (const std::exception& e) {
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "one_comp_model_namespace::write_array";
    (void) function__;  // suppress unused var warning
    ...
    try {
      ...
      for (int n = 1; n <= N_t; ++n) {
        ...
        assign(C_ppc,
          lognormal_rng(
            stan::math::log(rvalue(C, "C", index_uni(n), index_uni(1))),
            sigma, base_rng__), "assigning variable C_ppc", index_uni(n));
      }
  ...
  inline void get_param_names(std::vector<std::string>& names__) const {
    ...
    names__ = std::vector<std::string>{"k_a", "K_m", "V_m", "sigma", "C",
      "C_ppc"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    ...
    return std::string("[{\"name\":\"k_a\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"K_m\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"V_m\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"C\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N_t) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(1) + ",\"element_type\":{\"name\":\"real\"}}},\"block\":\"transformed_parameters\"},{\"name\":\"C_ppc\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N_t) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"generated_quantities\"}]");
