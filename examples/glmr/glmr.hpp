...
namespace stan {
  namespace math {
    ...
    auto to_matrix_cl(T&& x) {
      return var_value<matrix_cl<double>>(x);
    }
  }
}
...
class glmr_model final : public model_base_crtp<glmr_model> {
 ...
 private:
  ...
  matrix_cl<double> Xc_opencl__;
  matrix_cl<int> y_opencl__;
 ...
 public:
  ...
  std::vector<std::string> model_compile_info() const {
    ...
    stanc_info.push_back("stancflags = --use-opencl");
    return stanc_info;
  }
  ...
  glmr_model(stan::io::var_context& context__,
    ...
    try {
      ...
      Xc_opencl__ = to_matrix_cl(Xc);

      y_opencl__ = to_matrix_cl(y);
...
(void) function__;  // suppress unused var warning
    ...
    try {
        ...
        "assigning variable r_state_varmat");
      {
        ...
        lp_accum__.add(
          bernoulli_logit_glm_lpmf<propto__>(y_opencl__, Xc_opencl__,
            to_matrix_cl(
              add(
                add(
                  add(
                    add(
                      add(
                        ...
                        rvalue(r_educ_age_varmat,
                          cons_list(index_multi(J_educ_age),
                            nil_index_list()), "r_educ_age_varmat")),
                ...
                rvalue(r_state_varmat,
                  ...
                  "r_state_varmat"))), to_matrix_cl(b_varmat)));
