...
class Models_BugsExamples_Vol3_HSquare : 
  public Model_Test_Fixture<Models_BugsExamples_Vol3_HSquare> {
protected:
  virtual void SetUp() {}
public:
...
INSTANTIATE_TYPED_TEST_CASE_P(Models_BugsExamples_Vol3_HSquare,
            Model_Test_Fixture,
            Models_BugsExamples_Vol3_HSquare);
