...
void test_parser(const std::string &input, const std::string &expected_output) {
  ...
  cmdstan::json::rapidjson_parse(s, handler);
...
TEST(ioJson, jsonParserA9) {
  test_parser("[ [ [1, 2 ],[ 3, 4 ] ],[ [5, 6 ],[ 7, 8 ] ] ]", "S:text"
                                                               "S:arr"
                                                               "S:arr"
                                                               "S:arr"
                                                               "UL(INT):1"
...
TEST(ioJson, jsonParserO12) {
  test_parser("{  \"foo\" : { \"bar\": 1, \"baz\": 2 } }   ", "S:text"
                                                              "S:obj"
                                                              "KEY:\"foo\""
                                                              "S:obj"
                                                              "KEY:\"bar\""
...
TEST(ioJson, jsonParserO3) {
  test_parser("{\"foo\":1,\"bar\":2,\"baz\":[2]}", "S:text"
                                                   "S:obj"
                                                   "KEY:\"foo\""
                                                   "UL(INT):1"
                                                   "KEY:\"bar\""
...
TEST(ioJson, jsonParserStr13) {
  test_parser("[ \"D\xc3\xa9j\xc3\xa0 vu\" ]", "S:text"
                                               "S:arr"
                                               "STR:\"D\xc3\xa9j\xc3\xa0 vu\""
                                               "E:arr"
                                               "E:text");
...
TEST(ioJson, jsonParserErr02a) {
  test_exception("[ 0", "Missing a comma or ']' after an array element or "
...
TEST(ioJson, jsonParserErr02c) {
  test_exception("[ 99.9", "Missing a comma or ']' after an array element or "
                           "found a zero padded number.\n");
}

TEST(ioJson, jsonParserErr03) {
  test_exception("[ 000.005 ]", "Missing a comma or ']' after an array element "
...
TEST(ioJson, jsonParserErr12) {
  test_exception("[5}", "Missing a comma or ']' after an array element or "
                        "found a zero padded number.\n");
}
