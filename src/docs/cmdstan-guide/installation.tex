...
\begin{quote}
\begin{Verbatim}[fontshape=sl,fontsize=\small]
> tar --no-same-owner -xzf cmdstan-2.14.0.tar.gz 
\end{Verbatim}
\end{quote}
%
...
\begin{itemize}
  \item \Verb|STAN|. The location of the \Stan source
    directory. The default is \Verb|STAN=stan_2.14.0/|. Note: the
