...
Before the \stanc compiler can be used, its binary must be either copied or downloaded. This can be
directly using the makefile as follows. For Mac and Linux:
%
\begin{quote}
