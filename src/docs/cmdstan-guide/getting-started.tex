...
%
\begin{Verbatim}[fontsize=\small]
lp__,accept_stat__,stepsize__,treedepth__,n_leapfrog__,divergent__,E__,theta
\end{Verbatim}
%
...
\\
\NUTS & \Verb| E__ | & Hamiltonian value (energy)
\\ \hline
...
E__              7.7  4.6e-02  1.0e+00    6.8   7.4   9.6    491    29856  1.0e+00
