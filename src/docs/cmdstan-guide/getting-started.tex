...
Building \CmdStan involves preparing two executable programs:
%
\begin{itemize}
...
\end{itemize}
%
\CmdStan releases include binaries for three operating systems: \code{bin/linux-stanc}, \code{bin/mac-stanc} and \code{bin/windows-stanc}. When building \CmdStan, the appropriate binary is copied to \code{bin/stanc}. If no \code{stanc} binaries are found, the build step will download the appropriate binary of the Stan-to-C++ compiler's nightly release.
 \code{stanc}
%
