...
\noindent
This chapter is designed to help users get acquanited with the overall
design of the \Stan language and basic use of the \CmdStan
interface. Later chapters are devoted to expanding on the material in
this chapter with full reference documentation.
...
\begin{itemize}
  \item \code{stanc}, the \Stan compiler. The \Stan compiler
    translates a \Stan program into \Cpp code. See \refsection{stanc}
    for details.
  \item \code{print}, a posterior analysis tool. The \code{print}
    ...
    quantiles, R-hat, and other values. See \refsection{print} for
    details.
\end{itemize}
