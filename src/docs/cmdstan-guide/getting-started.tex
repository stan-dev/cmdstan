...
\begin{quote}
\begin{Verbatim}[fontshape=sl]
> ./bernoulli experimental variational
...
Gradient evaluation took 4e-06 seconds
1000 iterations under these settings should take 0.004 seconds.
Adjust your expectations accordingly!


This is Automatic Differentiation Variational Inference (mean-field).
...
the algorithm runs for another few thousand iterations until the mean change in
ELBO drops below the default tolerance of 1e-2.
