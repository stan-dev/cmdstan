\chapter{{\tt\bfseries diagnose}: Output Sanity Checking}\label{diagnose.chapter}
...
% This section cribbed from a similar section in stansummary
...
% This paragraph is cribbed from a similar section in stansummary
