#ifndef CMDSTAN_ARGUMENTS_CATEGORICAL_ARGUMENT_HPP
#define CMDSTAN_ARGUMENTS_CATEGORICAL_ARGUMENT_HPP
...
class categorical_argument : public argument {
 public:
  ...
  std::vector<argument *> &subarguments() { return _subarguments; }
